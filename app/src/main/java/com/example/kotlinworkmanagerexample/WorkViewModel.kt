...
class WorkViewModel : ViewModel() {
    ...
    var workIdForPeridic: UUID? = null
    ...
    fun startWorkManagerForPeriodicNotification() {
        val input = workDataOf("INPUT" to "Hello Worker!")

        val request = PeriodicWorkRequestBuilder<ExampleWorker>(15, TimeUnit.MINUTES)
            .setInputData(input)
            .build()

        workIdForPeridic = request.id
